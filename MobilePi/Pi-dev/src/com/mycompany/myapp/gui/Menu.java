...
l=s1.login(); //traja3l
  ...
  /*/
localNotificationReceived("votre Enfant a ete absent le 24/02/2020");
 localNotificationReceived("les Carnets sont pret a consulter");
  /*/
Toolbar tb = getToolbar();
Image icon = theme.getImage("icon.png"); 
Image icon2 = theme.getImage("back.jpg"); 
setBgImage(icon2);
Container topBar = BorderLayout.east(new Label(icon));
topBar.add(BorderLayout.SOUTH, new Label("Menu")); 
topBar.setUIID("SideCommand");
tb.addComponentToSideMenu(topBar);
tb.addCommandToLeftSideMenu("Inscription", theme.getImage("ins.png"), e -> {}); 

tb.addCommandToLeftSideMenu("Abscence", theme.getImage("abscence.png"), e -> {}); 
tb.addCommandToLeftSideMenu("Carnet", theme.getImage("carnet.png"), e -> {}); 
tb.addCommandToLeftSideMenu("Consulter Enfants", theme.getImage("kids.png"), e -> {}); 
tb.addCommandToLeftSideMenu("Consulter Produits", theme.getImage("produits.png"), e -> {
             }); 
tb.addCommandToLeftSideMenu("Panier", theme.getImage("panier.png"), e -> {
    
});
tb.addCommandToLeftSideMenu("Evenements", theme.getImage("evenements.png"), e -> {try {
    new ListEvent(current).show();
                } catch (ParseException ex) {
                   
                }
});
tb.addMaterialCommandToSideMenu("Participation", FontImage.MATERIAL_INFO, e -> { try {
    new ListMyevent(current).show();
                } catch (ParseException ex) {
                }
...
addComponent(new Label("Hello "+l.getUsername()));
show();
  ...
  getToolbar().setTitleComponent(
        ...
        fab.addActionListener(e -> {
            ...
            Button c1 = new Button(theme.getImage("contact-a.png"));
            Button c2 = new Button(theme.getImage("contact-b.png"));
            Button c3 = new Button(theme.getImage("contact-c.png"));
...
/*/
    ...
    public void localNotificationReceived(String notificationId) {
        CN.callSerially(() ->  ToastBar.showMessage(notificationId, FontImage.MATERIAL_CHECK, 5000));
    }
    /*/
