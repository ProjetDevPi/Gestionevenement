...
public class MailSend {
    public void sendMail()
    {
        try{
            ...
            String user = "mayssa.zaouali@esprit.tn";
            String pass = "mayssaesprit";
            String to = "mayssa.zaouali@esprit.tn";
            String from = "Russia";
    ...
    public  void sendMailWithHTML(){
      ...
      String from = "mayssa.zaouali@esprit.tn";
      ...
      properties.setProperty("mail.user", "mayssa.zaouali@esprit.tn");
      properties.setProperty("mail.password", "mayssaesprit");
      // Setup mail server
